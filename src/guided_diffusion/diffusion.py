...
class GaussianDiffusion(nn.Module):
    ...
    def feats_for_pc(self, x, noise=None):
        ...
        for t in self.steps:
            ...
            self.denoise_fn(x_noisy, continuous_sqrt_alpha_cumprod)
