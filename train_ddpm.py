...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/DDPM/ddpm_train.json',
    ...
    if opt['phase'] == 'train':
        ...
        while current_step < n_iter:
            ...
            for _, train_data in enumerate(train_loader):
                ...
                # log
                if current_step % opt['train']['print_freq'] == 0: # 일정 주기마다 print함 
                ...
                # validation
                if current_step % opt['train']['val_freq'] == 0: # 일정 주기마다 validation함
