...
def define_G(opt): # Image Denoising하는 module 
    ...
    # if opt['phase'] == 'train':
        ...
        # init_weights(netG, init_type='orthogonal') # 모델 weight initialize 부분 고쳐야 함. 
...
def create_model(
    ...
    #else:
        # channel_mults = tuple(int(ch_mult) for ch_mult in channel_mults.split(","))

    attention_ds = []
    #for res in attn_res.split(","):
    for res in attn_res: # attn_res is list in this model.
